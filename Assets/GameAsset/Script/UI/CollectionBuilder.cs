...
public class CollectionBuilder : MonoBehaviour
{
    ...
    private void Awake()
    {
		...
		BonusInStopInfo[0] = transform.Find("Info").gameObject;
		BonusInCutLine[0] = transform.Find("Line").gameObject;
		BonusInComaImg[0][0] = transform.Find("ComaSet").gameObject;
	...
	public void SetData(SlotEffectMaker2023.Data.CollectionDataElem nowPtn, int pID){
		Reset();
